  ...
  return (
    <div className="w-full">
      {getClassworksQuery.isLoading ? (
        ...
        <>
          {classworks.length === 0 || props.classroom.users.length === 0 ? (
            <div className="w-full gap-4 h-48 flex flex-col items-center justify-center">
              <div className="w-32">
                <SVG1 />
              </div>
              <small className="text-default-500 font-semibold">
                No exams or students
              </small>
            </div>
          ) : (
            <Table
